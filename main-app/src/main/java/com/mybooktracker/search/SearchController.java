package com.mybooktracker.search;
...
public class SearchController {
    ...
    //To make the REST API call to openlibrary api
    private final WebClient webClient;

    //Webclient Builder injected to constructor so that it's not called everytime from web api when a query is made
